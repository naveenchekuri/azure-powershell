            ...
            ConfirmAction(
                ...
                () =>
                {
                    ...
                    foreach (var peering in vVirtualRouter.Peerings)
                    {
                        ...
                        var vVirtualRouterPeering = this.NetworkClient.NetworkManagementClient.VirtualRouterPeerings.Get(ResourceGroupName, VirtualRouterName, resourceInfo.ResourceName);
