...
namespace Microsoft.Azure.Commands.Network
{
    ...
    public partial class UpdateAzureRmVirtualRouterPeer : NetworkBaseCmdlet
    {
        [Parameter(
            Mandatory = true,
        ...
        public override void Execute()
        {
            ...
            ConfirmAction(
                ...
                () =>
                {
                    ...
                    getVirtualRouter.Peerings.Add(new SubResource() { Id = vVirtualRouterPeerModel.Id });
                    this.NetworkClient.NetworkManagementClient.VirtualRouters.CreateOrUpdate(this.ResourceGroupName, this.VirtualRouterName, getVirtualRouter);
